...
namespace Emp_Consume_API.Controllers
{
    public class DepartmentsController : Controller
    {
        ...
        public async Task<Departments> Update(Departments employees)
        {
            ...
            client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/json"));
            List<Departments> empList = new List<Departments>();
            HttpResponseMessage response = await client.PutAsJsonAsync($"api/departments/{employees.Department_ID}", employees);
        ...
        {
            var data = await DeleteEmp(employees.Department_ID);
